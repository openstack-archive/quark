...
class TestDriverRegistry(BaseFunctionalTest):
    ...
    def _stubs(self, enable_nvp=False, enable_ironic=False,
        ...
        cfg.CONF.set_override('nvp_driver', enable_nvp, 'drivers')
        cfg.CONF.set_override('ironic_driver', enable_ironic, 'drivers')
        cfg.CONF.set_override('unmanaged_driver', enable_unmanaged, 'drivers')
