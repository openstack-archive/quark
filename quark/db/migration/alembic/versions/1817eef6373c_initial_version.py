...
def upgrade():
    ...
    op.create_table(
        ...
        mysql_engine='InnoDB')
    op.create_index(
        'ix_quark_security_groups_tenant_id',
        'quark_security_groups',
        ['tenant_id'],
        unique=False)
    op.create_table(
    ...
    op.create_table(
        ...
        mysql_engine='InnoDB')
    op.create_index(
        'ix_quark_mac_addresses_deallocated_at',
        'quark_mac_addresses',
        ['deallocated_at'],
        unique=False)
    op.create_table(
    ...
    op.create_table(
        ...
        sa.PrimaryKeyConstraint('id'),
        mysql_engine='InnoDB')
    op.create_index('ix_quark_networks_tenant_id',
                    'quark_networks',
                    ['tenant_id'],
                    unique=False)
    op.create_table(
    ...
    op.create_index('ix_quark_ports_device_id', 'quark_ports', ['device_id'],
                    unique=False)
    op.create_index('ix_quark_ports_name', 'quark_ports', ['name'],
                    unique=False)
    op.create_table(
        'quark_subnets',
        sa.Column('created_at', sa.DateTime(), nullable=True),
        ...
        sa.PrimaryKeyConstraint('id'),
        mysql_engine='InnoDB')
    op.create_index('ix_quark_subnets_segment_id', 'quark_subnets',
                    ['segment_id'],
                    unique=False)
    op.create_index('ix_quark_subnets_tenant_id', 'quark_subnets',
                    ['tenant_id'],
                    unique=False)
    op.create_table(
        'quark_routes',
    ...
    op.create_table(
        ...
        sa.PrimaryKeyConstraint('id'),
        mysql_engine='InnoDB')
    op.create_index('ix_quark_ip_addresses_address', 'quark_ip_addresses',
                    ['address'], unique=False)
    op.create_index('ix_quark_ip_addresses_deallocated_at',
                    'quark_ip_addresses',
                    ['deallocated_at'], unique=False)
    op.create_index('ix_quark_ip_addresses_version', 'quark_ip_addresses',
...
def downgrade():
    ...
    op.drop_index('ix_quark_ip_addresses_deallocated_at',
                  table_name='quark_ip_addresses')
    op.drop_index('ix_quark_ip_addresses_address',
                  table_name='quark_ip_addresses')
    op.drop_table('quark_ip_addresses')
    op.drop_table('quark_port_security_group_associations')
    op.drop_table('quark_routes')
    op.drop_index('ix_quark_subnets_tenant_id', table_name='quark_subnets')
    op.drop_index('ix_quark_subnets_segment_id', table_name='quark_subnets')
    op.drop_table('quark_subnets')
    op.drop_index('ix_quark_ports_name', table_name='quark_ports')
    op.drop_index('ix_quark_ports_device_id', table_name='quark_ports')
    ...
    op.drop_index('ix_quark_networks_tenant_id', table_name='quark_networks')
    op.drop_table('quark_networks')
    op.drop_table('quark_ip_policy_cidrs')
    op.drop_index('ix_quark_mac_addresses_deallocated_at',
    ...
    op.drop_index('ix_quark_security_groups_tenant_id',
