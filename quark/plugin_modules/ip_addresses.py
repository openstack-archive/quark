...
def get_ip_addresses(context, **filters):
    ...
    if 'deallocated' in filters and context.is_admin:
        # If another value besides True/False is specified, this will
        # cause _deallocated not to be added to filters, which means the
